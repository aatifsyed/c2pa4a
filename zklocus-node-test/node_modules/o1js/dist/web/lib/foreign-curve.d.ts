import { CurveParams, CurveAffine } from '../bindings/crypto/elliptic_curve.js';
...
declare class ForeignCurve {
     ...
     */
    toBigint(): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
    /**
    ...
    static get Bigint(): {
        ...
        hasCofactor: boolean;
        zero: import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        one: {
            infinity: boolean;
            x: bigint;
            y: bigint;
        ...
        readonly Endo: {
            ...
            endomorphism(P: import("../bindings/crypto/elliptic_curve.js").GroupAffine): {
                x: bigint;
                y: bigint;
            };
            scaleProjective(g: import("../bindings/crypto/elliptic_curve.js").GroupProjective, s: bigint): {
                x: bigint;
                y: bigint;
                z: bigint;
            };
            scale(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine, s: bigint): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        };
        from(g: {
            x: bigint;
            y: bigint;
        }): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        fromNonzero(g: {
            x: bigint;
            y: bigint;
        }): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        equal(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine, h: import("../bindings/crypto/elliptic_curve.js").GroupAffine): boolean;
        isOnCurve(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine): boolean;
        isInSubgroup(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine): boolean;
        add(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine, h: import("../bindings/crypto/elliptic_curve.js").GroupAffine): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        double(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        negate(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        sub(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine, h: import("../bindings/crypto/elliptic_curve.js").GroupAffine): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
        scale(g: import("../bindings/crypto/elliptic_curve.js").GroupAffine, s: bigint | boolean[]): import("../bindings/crypto/elliptic_curve.js").GroupAffine;
    };
    /**
