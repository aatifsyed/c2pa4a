...
import { Field3, Sum } from './foreign-field.js';
...
declare const Gadgets: {
     ...
     * ```
     */
    isInRangeN(n: number, x: Field): import("../bool.js").Bool;
    ...
    ForeignField: {
         ...
         * ```
         */
        assertMul(x: Field3 | Sum, y: Field3 | Sum, z: Field3 | Sum, f: bigint): void;
        /**
